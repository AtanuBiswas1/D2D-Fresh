...
<section class="show-products">
   ...
   <div style="height:60%">
       <div class="name" style="height:10%"><?= $fetch_products['name']; ?></div>
       <div class="cat" style="height:10%"><?= $fetch_products['category']; ?></div>
       <div class="details" style="height:50%"><?= $fetch_products['details']; ?></div>
       <div class="flex-btn" >
